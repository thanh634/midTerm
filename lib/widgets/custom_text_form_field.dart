...
class CustomTextFormField extends StatelessWidget {
  const CustomTextFormField({
    ...
    this.contentPadding,
    this.borderDecoration, this.fillColor,
    this.filled = false,
    this.validator
  });
  ...
  Widget textFormFieldWidget(BuildContext context) =>
      Container(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.titleSmallPoppinsPrimarySemiBold,
  ...
  InputDecoration get decoration =>
      InputDecoration(
        hintText: hintText ?? "",
        hintStyle:
        hintStyle ?? CustomTextStyles.titleSmallPoppinsPrimarySemiBold,
        prefixIcon: prefix,
